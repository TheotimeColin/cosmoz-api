...
const { consteCreate, consteApply, consteLeave, consteEnter, consteInviteLink, consteInviteLinkDelete, consteGet } = require('./api/constellation')
...
mongoose.connection.once('open', async () => {
    ...
    app.get('/constellation/get', consteGet)
